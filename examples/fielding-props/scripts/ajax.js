...
var ajax = {
  ...
  // http get methods
  httpGet: function(url, urlVars, callbackFunction, expectingXML, callingContext, reqHdrs, async) {
    return this._callServer(url, urlVars, callbackFunction, expectingXML,
                    callingContext, "GET", null, null, null, reqHdrs, async);
  },
  ...
  // http post methods
  httpPost: function(url, optionalURLVars, callbackFunction, expectingXML,
  ...
  httpPostVars: function(url, bodyVars, optionalURLVars, callbackFunction, expectingXML,
             callingContext, reqHdrs) {
      this._callServer(url, optionalURLVars, callbackFunction, expectingXML,
                      callingContext, "POST", bodyVars, null, null, reqHdrs);
  },

  httpPostMultiPart: function(url, bodyVars, optionalURLVars, callbackFunction, expectingXML,
             callingContext, reqHdrs) {
      this._callServer(url, optionalURLVars, callbackFunction, expectingXML,
  ...
  httpPut: function(url, optionalURLVars, callbackFunction, expectingXML,
             callingContext, bodyType, body, reqHdrs) {
      this._callServer(url, optionalURLVars, callbackFunction, expectingXML,
  ...
  httpOptions: function(url, optionalURLVars, callbackFunction, expectingXML,
             callingContext, bodyType, body, reqHdrs) {
      this._callServer(url, optionalURLVars, callbackFunction, expectingXML,
                      callingContext, "OPTIONS", null, bodyType, body, reqHdrs);
  },

  httpTrace: function(url, optionalURLVars, callbackFunction, expectingXML,
             callingContext, bodyType, body, reqHdrs) {
      this._debug("trace");
      this._callServer(url, optionalURLVars, callbackFunction, expectingXML,
  ...
  httpPutForm: function(url, optionalURLVars, callbackFunction, expectingXML,
  ...
  httpDeleteForm: function(url, optionalURLVars, callbackFunction, expectingXML,
             callingContext, bodyType, formRef, reqHdrs) {
  ...
  httpPostForm: function(url, optionalURLVars, callbackFunction, expectingXML,
             callingContext, bodyType, formRef, reqHdrs) {
  ...
  *************************************************************************/
  ...
  _callServer: function(url, urlVars, callbackFunction, expectingXML,
                       ...
                       explicitBodyType, explicitBody, reqHdrs, async) {
    ...
    try
    {
        xReq.open(requestMethod, url, ar);
    }
    catch(ex)
    {
        alert(
  ...
  _onResponseStateChange: function(call) {
    ...
    if (call.ready != true && xReq.readyState < 4) { //Still waiting
      return;
    }
    ...
    if (xReq.readyState == 4) { //Transmit to actual callback
      ...
      try
      {
        r_status = xReq.status;
      }
      catch(ex){}
      try
      {
        r_text = xReq.statusText;
      }
      catch(ex){}
      
      callbackFunction(content, headersForCaller, call.callingContext, r_status, r_text);
    }
